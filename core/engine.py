...
class OnyxEngine:
    ...
    def _print_banner(self):
        ...
        print(f"{v}  === === === === === === === === === === ==={nc}")
        print()
        print(f"{v}   OOOO  N   NN YY   YY XXXX  XXX{nc}")
        print(f"{v}  O    O NN   N YY YY  X   X X   X{nc}")
        print(f"{v}  O    O N N  N  YYY   XXXX  XXX{nc}")
        print(f"{v}  O    O N  N N  YYY   X   X X  X{nc}")
        print(f"{v}   OOOO  N   NN  YY    X   X X   X{nc}")
        print()
